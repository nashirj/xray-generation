"""Source: https://github.com/lucidrains/denoising-diffusion-pytorch/blob/main/denoising_diffusion_pytorch/classifier_free_guidance.py"""
...
if __name__ == '__main__':
    ...
    training_images = torch.randn(4, 3, 128, 128).cuda() # images are normalized from 0 to 1
    image_classes = torch.randint(0, num_classes, (4,)).cuda()    # say 10 classes

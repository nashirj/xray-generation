...
class GaussianDiffusion(nn.Module):
    def __init__(
        ...
        *,
        ...
        # Add device to prevent sampling errors
    ...
    def model_predictions(self, x, t, x_self_cond = None, clip_x_start = False, rederive_pred_noise = False):
        print("in model preds")
        model_output = self.model(x, t, x_self_cond)
        print("in model preds 2")
    ...
    def p_mean_variance(self, x, t, x_self_cond = None, clip_denoised = True):
        print("in p_mean_variance")
        preds = self.model_predictions(x, t, x_self_cond)
        print("in p_mean_variance 2")
        x_start = preds.pred_x_start
        print("in p_mean_variance 3")

        if clip_denoised:
            x_start.clamp_(-1., 1.)

        print("in p_mean_variance 4")
        model_mean, posterior_variance, posterior_log_variance = self.q_posterior(x_start = x_start, x_t = x, t = t)
        print("end p_mean_variance")
